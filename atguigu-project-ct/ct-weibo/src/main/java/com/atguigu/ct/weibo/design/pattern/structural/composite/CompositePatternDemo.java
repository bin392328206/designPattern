package com.atguigu.ct.weibo.design.pattern.structural.composite;
...
public class CompositePatternDemo {
    ...
    public static void main(String[] args) {
        ...
        Employee headSales = new Employee("Michel", "Head marketing", 20000);
        Employee headMarketing = new Employee("Michel2","Head Marketing", 20000);
...
//                if (subordinateSubordinate.getSubordinates().size()==0){
//                }
//            }
//        }
        getEmployee(CEO);
